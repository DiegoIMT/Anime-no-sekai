...
function openProductForm(p=null,duplicating=false){
 ...
 <label><span class="fieldLabel">Nombre <span class="required">*</span></span><input name="nombre" maxlength="150" required value="${attr(p?.nombre||'')}"></label><div class="catalogField"><span>Franquicia</span><div class="catalogPicker"><div class="searchableSelect" id="franquiciaCombo"><input class="searchableSelectInput" id="franquiciaSearch" type="text" autocomplete="off" placeholder="Buscar franquicia…"><button class="searchableSelectArrow" type="button" tabindex="-1" aria-label="Mostrar franquicias">⌄</button><div class="searchableSelectMenu"></div><select name="franquicia_id" id="franquiciaSelect" class="catalogNativeSelect"><option value="">Cargando franquicias…</option></select></div><button class="catalogAdd" id="addFranquicia" type="button">＋ Nueva</button></div><small class="fieldHint">Escribe para buscar una franquicia existente o créala sin salir del producto.</small></div>
...
function openAdditionalProductForm(p=null,duplicating=false){
 ...
 <label class="full"><span class="fieldLabel">Nombre <span class="required">*</span></span><input name="nombre" maxlength="150" required value="${attr(p?.nombre||'')}"></label>
