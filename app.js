...
function openHelpView(push=true){
 ...
 <details><summary><span>08</span><b>¿Puedo compartir una figura o producto?</b></summary><div><p>Sí. Desde el detalle puedes usar <strong>Compartir</strong> para enviarlo por WhatsApp u otras aplicaciones compatibles. También puedes compartir Anime no Sekai desde el pie de la tienda.</p></div></details>
 </div><div class="helpContact"><span class="kicker">¿TODAVÍA TIENES DUDAS?</span><h2>Estamos para ayudarte</h2><p>Escríbenos directamente y resolveremos tu consulta.</p><a class="whatsapp" href="https://wa.me/529994739090?text=${encodeURIComponent('Hola, necesito ayuda con Anime no Sekai.')}" target="_blank" rel="noopener">◉ Preguntar por WhatsApp</a></div></div>`;
 ...
 if(push)history.pushState({help:true},'','#ayuda');
}
...
renderStoreShell();
if(location.hash==='#ayuda')setTimeout(()=>openHelpView(false),0);
...
window.addEventListener('hashchange',()=>{if(location.hash==='#admin')openAdmin();else if(location.hash==='#ayuda'&&!document.getElementById('helpView'))openHelpView(false)});
