...
function applySiteConfig(c){
 ...
 set('amiHomeName',c.ami_nombre||'Ami no Sekai');set('amiHomeText',c.ami_texto_inicio||c.ami_descripcion||'Tejiendo pequeños mundos. Amigurumis y creaciones artesanales con una identidad propia.');
